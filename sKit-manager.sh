...
check_space() {
    ...
    space=$(/bin/df -m /mnt/sda2 | tail -1 | awk '{print $4}')
    total=$(/bin/df -m /mnt/sda2 | tail -1 | awk '{print $2}')
...
#!/bin/sh
#sKit enviroment
export PATH=$PATH:/mnt/sda2/tce/sKit/bin
EOF
